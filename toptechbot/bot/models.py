...
class Page(models.Model):
    ...
    is_published = models.BooleanField(
        default=False,
        help_text=(
            'Este campo precisa ser marcado '
            'para a página ser apresentada publicamente.'
        ),
    )
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('bot:index')
        return reverse('bot:page', args=(self.slug,))
...
class Post(models.Model):
    ...
    is_published = models.BooleanField(
        ...
        help_text=(
            ...
            'para o post ser apresentado publicamente.'
        ),
    )
    content = models.TextField()
    ...
    cover_in_post_content = models.BooleanField(
        default=True,
        help_text='Se for marcado, exibe a capa dentro do post.',
    )
    ...
    def get_absolute_url(self):
        if not self.is_published:
            return reverse('bot:index')
        return reverse('bot:post', args=(self.slug,))
